...
import { FieldContainer, Input, TextArea } from '../Utils/common';
...
function Carts() {
    ...
    return (
        <div className='cart-component'>
            <div className="title"><FiShoppingCart className='icon' /> Mon panier</div>
            {
                items.length < 1 ?
                <Empty image={Empty.PRESENTED_IMAGE_SIMPLE} description="Votre panier est vide" />:
                <div className="content">
                    ...
                    <div className="rigth">
                        ...
                        <Button type="primary" className='btn checkout' onClick={() =>history.push({ pathname: '/checkout', state: { note } })}>Passer à la caisse</Button>
                    </div>
                </div>
            }
        </div>
